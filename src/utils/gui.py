...
class MainWindow(QMainWindow):
	...
	def mod_changed(self, sender):
		...
		if self.selected_mod_name == 'base':
			self.ui.libraryModInfoDescriptionContents.setText('''
...
I'm super excited for you to make friends with everyone and help the Literature Club become a more intimate place for all my members. But I can tell already that you're a sweetheart—will you promise to spend the most time with me? ♥
			''')
			self.ui.libraryModInfoAuthor.setText('Team Salvato')
		else:
			self.ui.libraryModInfoDescriptionContents.setText('Description Text')
			self.ui.libraryModInfoAuthor.setText('Author')
			# :)
